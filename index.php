...
//skript query cek data ke dalam database
	
	$sql = mysqli_query($koneksi, "SELECT id_user, username, nama,level 
									FROM user 
...
<!-- Bootstrap core JavaScript, Placed at the end of the document so
