...
<button type="submit" name="cari" class="btn btn btn-success btn-s pull-right">Cari</button>
</div>
</div>
</form>
<?php
...
$sql = mysqli_query($koneksi, "SELECT a.kode_part, a.nama_part, a.harga_part, a.jml_stok, b.nama_produk FROM sparepart a, jenis_produk b where a.kode_produk=b.kode_produk and a.kode_produk is not null");
}
else{
$sql = mysqli_query($koneksi, "SELECT a.kode_part, a.nama_part, a.harga_part, a.jml_stok, b.nama_produk FROM sparepart a, jenis_produk b where a.kode_produk=b.kode_produk and a.kode_produk='$kode_produk'");
}
...
untuk ditampilkan. <u><a href="?hlm=sparepartAdd">Tambah Sparepart Baru</a></u> </p></center></td></tr>';
}
echo '
</tbody>
</table>
