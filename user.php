...
<a href="./admin.php?hlm=user&aksi=add" class="btn btn-success
btn-s pull-right">Tambah User</a>
<br/><hr/>
...
<a href="?hlm=user&aksi=edit&id_user='.$row['id_user'].'" class="btn
btn-warning btn-s">Edit</a>
<a href="?hlm=user&aksi=delete&submit=yes&id_user='.$row['id_user'].'"
...
untuk ditampilkan. <u><a href="?hlm=user&aksi=add">Tambah user
