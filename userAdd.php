...
$sql = mysqli_query($koneksi, "INSERT INTO user(username,
password, nama, level) VALUES('$username', '$password',
'$nama', '$level')");
if($sql == true){
...
<label for="username" class="col-sm-2 controllabel">
Username</label>
<div class="col-sm-3">
...
<div class="form-group">
<label for="password" class="col-sm-2 controllabel">
Password</label>
<div class="col-sm-3">
